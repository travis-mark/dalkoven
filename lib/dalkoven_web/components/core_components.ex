defmodule DalkovenWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DalkovenWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DalkovenWeb.Gettext, "errors", msg, opts)
    end
  end
